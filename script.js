...
/* ── PRODUCTS DATA ──
   To add real images: change the `image` field to e.g. "../images/sailor-tee-cream.jpg"
   Images should be saved inside the /images/ folder
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
const PRODUCTS = {
  mens: [
    {
      ...
      // Replace with: image: '../images/sailor-tee.jpg'
    },
    {
      id: 'm2',
      name: 'Smooth Sea Tee',
...
function addToCart() {
  ...
  /* ─────────────────────────────────────────
     STRIPE / WOOCOMMERCE INTEGRATION POINT
     ─────────────────────────────────────────
     When ready to connect payments, replace
     this comment block with your integration:
     ...
     WOOCOMMERCE:
     ────────────────
     Use the WooCommerce REST API or a plugin
     like WP WooCommerce Stripe to handle this.
     See: https://woocommerce.com/document/stripe/
  ───────────────────────────────────────── */
}
